...
<form:form  method="POST" modelAttribute="shippingdetails">
		...
		<form:label path="Addr1">DOOR NO & SREEET NAME</form:label><br>
		<form:input path="Addr1"  required="true"
						class="form-control input-md" pattern="{,255}" placeholder="Enter the address line"/>
		<c:forEach
		...
		<hr>
		<form:label path="Addr2">NAGAR</form:label><br>
		...
		<hr>
		<form:label path="Addr3">AREA</form:label><br>
		...
		<form:input path="pincode" required="true" title="NUMBERS ONLY VALID> LENGTH MUST BE 6"
		...
		<form:input path="PhoneNumber" required="true" title="NUMBERS ONLY VALID. LENGTH MUST BE 10"
	...
	<c:forEach
			...
			<div class="col-md-2 col-md-offset-5"> 
				<button style="align:center" class="btn btn-md btn-success btn-block signup-btn pull-right"
									name="_eventId_submit" type="submit" value="Submit" >Submit</button></div></div>
</form:form>
</div>
